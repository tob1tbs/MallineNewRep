...
class Product extends Model
{
	...
	protected $fillable = ['id', 'name_ge', 'name_en', 'category_id', 'description', 'discount_price', 'discount_percent', 'photo', 'count', 'stock', 'used', 'preorder', 'vendor_id', 'status', 'active', 'facebook', 'deleted_at', 'deleted_at_int'];
